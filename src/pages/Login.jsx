    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 bg-[radial-gradient(#e2e8f0_1px,transparent_1px)] [background-size:24px_24px]">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 font-bold uppercase tracking-[0.2em] text-[10px]">Smarter Healthcare Starts Here</p>
        </div>
        ...
        <div className="premium-card bg-white p-10 relative overflow-hidden">
          ...
          <h2 className="text-xl font-black text-slate-800 mb-8 tracking-tight">Log-In to QueueSeva</h2>
          ...
          <div className="mt-10 pt-8 border-t border-slate-50 flex items-center justify-center gap-4">
            ...
            <p className="text-[10px] font-bold text-slate-400 leading-tight uppercase tracking-widest">"Designed to streamline patient flow effortlessly.
              Stay updated without standing in long lines.
              A calmer, smarter healthcare experience."</p>
          </div>
        </div>

        <p className="text-center mt-8 text-xs font-bold text-slate-400 uppercase tracking-widest">
          New to QueueSeva? <Link to="/signup" className="text-primary font-black hover:underline cursor-pointer">Create Account.</Link>
        </p>
